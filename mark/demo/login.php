                        ...
                        <ul class="nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="custom-view.php">Custom View</a>
                                        </li>
                                        <li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="demo-horizontal-nav.php">Horizontal</a>
                                        </li>
                                        <li>
                                            <a href="demo-horizontal-fixed-nav.php">Horizontal Fixed</a>
                                        </li>
                                        <li>
                                            <a href="demo-vertical-nav.php">Vertical</a>
                                        </li>
                                        <li>
                                            <a href="demo-vertical-fixed-nav.php">Vertical Fixed</a>
                                        </li>
                                    </ul>
                                </li>
                ...
                <div class="signin-row row">
                    ...
                    <div class="span8">
                        <div class="container-signin">
                            ...
                            <form action='dashboard.php' method='POST' id='loginForm' class='form-signin' autocomplete='off'>
