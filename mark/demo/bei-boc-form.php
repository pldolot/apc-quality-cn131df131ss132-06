...
<head>
    ...
    <title>BEI/BOC Registration Form</title>
                ...
                <div class="row">
                    <div class="span7">
                        <header class="page-header">
                            <h3>BEI/BOC Profile<br/><small>BEI/BOC Account Registration</small></h3>
                        </header>
                    </div>
                    <div class="span9">
                            ...
                            <fieldset>
                                <legend>BEI/BOC Form</legend><br>
                                 ...
                                 <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="fname" class="span4" type="password" value="" autocomplete="false">
                                 ...
                                 <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="lname" class="span4" type="password" value="" autocomplete="false">
                                ...
                                <br>
                                 ...
                                 <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="mname" class="span4" type="password" value="" autocomplete="false">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="mmname" class="span4" type="password" value="" autocomplete="false">
                                 ...
                                 <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="phonenumber" class="span4" type="password" value="" autocomplete="false">
                                    ...
                                    <div class="controls">
                                        <input id="current-pass-control" name="" class="span4" type="file" value="" autocomplete="false">
